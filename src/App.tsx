            ...
            <form>
                <SymplStepper activeIndex={0}>
                    <SymplStep name="Sample Grid" icon="si-verified">
                        <SymplProgressBar percentComplete={55} label="Validating..."></SymplProgressBar>
                        ...
                        <div className="my-3">
                            <SymplPaginator total={50} showSizeChanger showTotal></SymplPaginator>
                        </div>
                    </SymplStep>
                    ...
                    <SymplStep name="Controls with Icons" icon="si-pencil">
